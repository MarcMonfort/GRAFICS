...
void BoundingBoxCapsaUnitaria::pintarCapsa(int i) {
...
GLWidget &g = *glwidget();
  ...
  Box   bBox = scene()->objects()[i].boundingBox(); // com només hi ha un esta a la posicio 0
...
void BoundingBoxCapsaUnitaria::cleanUp()	//no usar! es unitaria siempre!!!!
{
